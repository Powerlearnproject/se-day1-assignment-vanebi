[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=18422636&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
(b) Specificity of Requests: The more detailed the prompt, the better the AI can tailor its output. Specific prompts lead to more relevant and focused responses, improving the overall interaction experience.

(c) Experimentation and Learning: By experimenting with different prompts, users can discover how AI interprets various instructions, enabling them to refine their prompts for better results.
